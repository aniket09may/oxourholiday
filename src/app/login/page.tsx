...
export default function LoginPage() {
  ...
  return (
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-[#061b26] px-5 pb-16 pt-34 text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_15%,rgba(42,126,119,.16),transparent_28%),radial-gradient(circle_at_85%_80%,rgba(215,173,103,.18),transparent_25%)]" />
      ...
      <div className="glass-panel animate-fade-up relative w-full max-w-md rounded-[2rem] p-7 sm:p-9">
        <div className="mb-8 text-center">
          <span className="mx-auto mb-4 grid h-12 w-12 place-items-center rounded-full border border-[#d7ad67]/45 bg-[#d7ad67]/10 font-bold text-[#e8cf9b]">O</span>
          <p className="mb-2 text-xs font-bold uppercase tracking-[0.18em] text-[#d7ad67]">Team access</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button type="submit" disabled={isLoading} className="accent-button flex w-full items-center justify-center gap-2 rounded-full px-6 py-3.5 text-sm font-bold disabled:cursor-not-allowed disabled:opacity-60">
